...
public class AuthController {
    ...
    /*@PostMapping("/login")
    public String login(@RequestParam String name, @RequestParam String pass, HttpSession session, Model model) {
        AdminEntity admin = adminRepo.findByName(name).orElse(null);
        UserEntity user = userRepo.findByName(name).orElse(null);
